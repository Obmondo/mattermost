...
docker-build-local: ## Build a local production-style Docker image from source.
	$(MAKE) build-linux-amd64 package-prep BUILD_ENTERPRISE=true
	$(MAKE) package-general DIST_PATH_GENERIC=dist/mattermost CURRENT_PACKAGE_ARCH=linux_amd64 MM_BIN_NAME=mattermost MMCTL_BIN_NAME=mmctl BUILD_ENTERPRISE=true
